...
import * as messagesController from '../../src-ts/controllers/messages.controller';
import MessageModel from '../../src-ts/models/messageModel';
...
jest.mock('../../src-ts/models/messageModel');
